...
<head>
    ...
    <style>
        ...
        body:hover {
            background-color: rgb(29, 116, 107);
            border-radius: 50%;
            transition-duration: 3s;
        ...
        .moving{
            width: 100%;
            height: 500px;
            background: url(img/pngtree-civilization-ride-subway-illustration-background-sceneillustration-image_86626.jpg) 0 / 500px repeat-x;
...
<body>
    ...
    <div class="search-wrapper">
        <div class="input-holder">
            <input type="text" class="search-input" placeholder="지하철역...">
