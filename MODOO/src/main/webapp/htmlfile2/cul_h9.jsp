	...
	<div id="cul_h9">
		...
		<div class="modal1">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn1" value="정보 보기" />
		...
		<div class="modal2">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn2" value="정보 보기" />
		...
		<div class="modal3">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn3" value="정보 보기" />
		...
		<div class="modal4">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn4" value="정보 보기" />
		...
		<div class="modal5">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn5" value="정보 보기" />
		...
		<div class="modal6">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn6" value="정보 보기" />
		...
		<div class="modal7">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn7" value="정보 보기" />
		...
		<div class="modal8">
			<div class="modal_content" title="클릭">
				<input type="button" id="cul_h9_btn8" value="정보 보기" />
...
<script type="text/javascript" src="/js/cul_9.js"></script>
</body>
</html>